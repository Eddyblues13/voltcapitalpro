...
class ManageUserAddressVerificationController extends Controller
{
    public function index($userId)
    {
        ...
        return view('admin.user.address.index', compact('verifications', 'user'));
    }
    ...
    public function show($userId, $id)
    {
        ...
        return view('admin.user.address.show', compact('verification', 'user'));
    }
