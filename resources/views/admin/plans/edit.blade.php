                                ...
                                <form id="editPlanForm" method="POST"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.01" name="price"
                                            class="form-control bg-dark text-light" value="{{ $plan->price }}" required>
                                    </div>

                                    <div class="form-group">
                                        <label class="text-light">Swap Fee</label>
                                        <select name="swap_fee" class="form-control bg-dark text-light">
                                            <option value="0" {{ !$plan->swap_fee ? 'selected' : '' }}>No</option>
                                            <option value="1" {{ $plan->swap_fee ? 'selected' : '' }}>Yes</option>
                                        </select>
                                    </div>
