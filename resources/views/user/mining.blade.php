                ...
                <div class="h-balance-section d-flex align-items-center">
                    <div class="h-balance-box">
                        <div class="h-balance-value text-white small-amount">{{ config('currencies.' .
                            Auth::user()->currency, '$') }}{{ number_format($miningBalance, 1) }}</div>
                        <div class="h-balance-label text-white">mining Balance</div>
                    </div>
                    <div class="h-balance-box">
                        <div class="h-balance-value text-white small-amount">{{ config('currencies.' .
                            Auth::user()->currency, '$') }}{{ number_format($miningBalance, 1) }}</div>
                        <div class="h-balance-label text-white">Value of minings</div>
                    </div>
                </div>
            </div>
